...
1. Kubernetes: [v1.36.1](https://github.com/kubernetes/kubernetes/releases/tag/v1.36.1)
1. Kustomize: [kustomize/v5.8.1](https://github.com/kubernetes-sigs/kustomize/releases/tag/kustomize/v5.8.1)
1. Helm: [v4.3.0](https://github.com/helm/helm/releases/tag/v4.3.0)
1. Traefik: [v3.7.13](https://github.com/traefik/traefik/releases/tag/v3.7.13)
1. ArgoCD: [v3.5.3](https://github.com/argoproj/argo-cd/releases/tag/v3.5.3)
1. Prometheus-Operator: [v0.94.1](https://github.com/prometheus-operator/prometheus-operator/releases/tag/v0.94.1)
1. Prometheus: [v3.15.0](https://github.com/prometheus/prometheus/releases/tag/v3.15.0)
1. Grafana: [13.2.2](https://github.com/grafana/grafana/releases/tag/v13.2.2)
1. Grafana Operator: [v5.25.0](https://github.com/grafana/grafana-operator/releases/tag/v5.25.0)
1. Grafana Loki: [not pinned](https://github.com/grafana/loki)
1. Grafana Tempo: [not pinned](https://github.com/grafana/tempo)
1. Jaegar: [not pinned](https://github.com/jaegertracing/jaeger)(ToDo)
1. Strimzi: [1.2.0](https://github.com/strimzi/strimzi-kafka-operator/releases/tag/1.2.0)
1. Kind: [v0.33.0](https://github.com/kubernetes-sigs/kind/releases/tag/v0.33.0)
1. Ingress Nginx Controller: [controller-v1.15.1](https://github.com/kubernetes/ingress-nginx/releases/tag/controller-v1.15.1)
1. Conftest: [v0.24.0](https://github.com/open-policy-agent/conftest/releases/tag/v0.24.0)
1. Istio: [1.31.1](https://github.com/istio/istio/releases/tag/1.31.1)
1. Postgres Operator: [v2.0.2](https://github.com/zalando/postgres-operator/releases/tag/v2.0.2)
1. KNative: [not pinned](https://github.com/knative/serving)
1. Skaffold: [not pinned](https://github.com/GoogleContainerTools/skaffold)
1. eck: [3.5.0](https://github.com/elastic/cloud-on-k8s/releases/tag/v3.5.0)
1. Kyverno: [not pinned](https://github.com/kyverno/kyverno)(ToDo)
1. Polaris: [not pinned](https://github.com/FairwindsOps/polaris)
1. Kubeflow: [not pinned](https://github.com/kubeflow/kubeflow)
1. Vitess: [v24.0.3](https://github.com/vitessio/vitess/releases/tag/v24.0.3)(ToDo)
1. TiDB: [not pinned](https://github.com/pingcap/tidb)(ToDo)
1. TimescaleDB: [not pinned](https://github.com/timescale/timescaledb-kubernetes)(ToDo)
